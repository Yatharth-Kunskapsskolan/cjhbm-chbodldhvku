...
function preload()
{
    classification = ml5.imageClassifier('DoodleNet'); 
}
...
{
    classification.classify(canvas, gotResult);
}
...
function gotResult(error, results)
{
    ...
    document.getElementById('label').innerHTML = 'You have drawn a ' + results[0].label + '!';
